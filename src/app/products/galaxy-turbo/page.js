...
export default function GalaxyTurbo() {
  ...
  const product = {
    name: "Galaxy Turbo",
    img: "/all_products/turbo/Galaxy_Turbo.jpg",
  ...
  return (
    <section style={{ padding: "140px 50px", background: "#0c0c0c", color: "#fff", fontFamily: "Poppins, sans-serif", minHeight: "100vh" }}>
      <button
      ...
      <div style={{ display: "flex", gap: "48px", maxWidth: "1400px", margin: "auto", alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: "1.3", minWidth: "350px", background: "rgba(255,255,255,0.03)", padding: "34px", borderRadius: "18px", border: "1px solid rgba(255,255,255,0.06)" }}>
          <h1 style={{ fontSize: "40px", fontWeight: "700", marginBottom: "16px", background: "linear-gradient(90deg,#d4af37,#f7e98e)", WebkitBackgroundClip: "text", color: "transparent" }}>{product.name}</h1>
